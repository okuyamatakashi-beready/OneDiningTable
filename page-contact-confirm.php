...
<main>
	...
	<div id="mv">
		<div class="flex">
			...
			<div class="mv_right">
				...
				<figure>
					<img src="<?php echo get_template_directory_uri(); ?>/images/mv_ttl.png" alt="「いただきます」は楽しい。を知ってもらいたい！OneDiningTableFes">
				</figure>
			</div>
		</div>
	...
	<section id="about" class="bg">
		...
		<ul class="flex sns_list about_sns sp">
			<li>
				<a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/insta_white.svg" alt=""></a>
			</li>
			<li>
				<a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/twitter_white.svg" alt=""></a>
			</li>
			<li>
				<a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/fb_white.svg" alt=""></a>
			</li>
		</ul>
	</section>
	<!-- //about -->
	...
	<section id="concept" class="sec">
		<div class="container concept_wrap">
			...
			<div class="concept_text">
				...
				<b>いただきますって、<span>素敵</span>なことば。</b>
			</div>
			<!-- //concept_text -->
		</div>
		<!-- //container -->
	...
	<section id="odt" class="sec">
		<div class="container">
			<div class="flex">
				...
				<div class="odt_text">
					<p>
					孤食という社会問題に対し、お弁当を通じてご家庭をサポートする<br>
					子ども食堂活動<br>
					・滝川だんらん食堂（昭和区）<br>
					・出張だんらん食堂（中区）
					</p>
					...
					<p>
						0歳児から健康なお口づくりを目指す、歯科医師による「親子で参加する授乳・離乳食セミナー」<br>
						授乳や離乳食などの悩みを専門家たちに相談できる育児サロン「みまもろ」など<br>
						名古屋市での活動を中心に出張講演やオンラインでのサポートを行っている団体です。
					</p>
	...
	<section id="kodomo" class="sec">
		...
		<div class="container">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/images/kodomo_illust02.svg" alt="">
		</div>
		<!-- //container -->
	...
	<section id="aword" class="sec">
		<div class="container">
			<img src="<?php echo get_template_directory_uri(); ?>/images/award_img.svg" alt="">
			<h2 class="sec_ttl">
				<span>AWARD</span>
			</h2>
			<b class="coming">Coming soon...</b>
		</div>
	</section>
	<!-- //aword -->


	<section id="stage" class="sec coming_soon">
		<div class="container">
			<h2 class="sec_ttl">
				<span>
					STAGE
			...
			<p class="sec_text">
				高校生による高校生のためのバンド選手権「TEENS ROCK AICHI」<br>
				とのコラボによる高校生バンドも出演予定。<br>
				ステージから放たれる若いエネルギーを受け取ってください！
			</p>
	...
	<section id="workshop" class="sec coming_soon">
		<div class="container">
			<img src="<?php echo get_template_directory_uri(); ?>/images/workshop_img.svg" alt="">
			<h2 class="sec_ttl">
				<span>
					WORKSHOP
				</span>
			...
			<p class="sec_text">
				大小さまざまなブースには飲食ブースやワークショップブース、<br class="pc">
				職業体験できるブース、子ども食堂ブースなど<br class="pc">
				楽しめる内容を企画しています。
			</p>
	...
	<section id="contact" class="sec">
		<div class="container">
			...
			<div class="form_wrap">
				...
				<?php echo do_shortcode('[contact-form-7 id="400" title="ODTコンタクトフォーム確認"]'); ?>
	...
	<footer id="footer" class="sec">
		<figure class="ft_logo">
			<img src="<?php echo get_template_directory_uri(); ?>/images/mv_ttl.png" alt="">
		</figure>
		<div class="sns_line">
			<div class="sns_container">
				<div class="flex">
